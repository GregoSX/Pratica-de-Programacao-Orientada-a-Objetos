...
public class Tela {
    ...
    private void criarCompetidores() {
        ...
        competidores.add(new Corredor("Grego", 5));
        competidores.add(new Corredor("Selmo", 4));
        competidores.add(new Corredor("Angelica", 3));
        competidores.add(new Corredor("Mario", 3));
