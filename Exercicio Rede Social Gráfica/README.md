[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8220627&assignment_repo_type=AssignmentRepo)
# Rede Social Gráfica
...
Para evitar este tipo de problema poderiamos emitir um sinal ou evento que interrompe a execução dos métodos 'comentar' e 'curtir' e que, se não for tratado pelo objeto da classe 'TelaRedeSocial', pode encerrar o programa.
Isso é a forma mais eficaz de uma classe indicar para o objeto que a utiliza que não é possível atender à sua requisição. Também, esse tratamento independe do retorno do método.
Alterando o tipo de retorno do método a classe cliente pode tratar o retorno do método de forma apropriada. Mas, em alguns casos os retornos false e null são válidos e não erros e a classe cliente poderia simplesmente ignorar o retorno do método.
