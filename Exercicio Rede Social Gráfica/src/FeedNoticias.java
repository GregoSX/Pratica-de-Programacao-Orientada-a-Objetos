...
public class FeedNoticias {
    ...
    // lista de autores das mensagens
     ...
     */
    private void addAutor(String autor) {
        autores.add(autor);
    }
    ...
    /**
     * Metodo que recebe um autor por parâmetro e retorna apenas a lista de publicações (somente-leitura) dele.
     * 
     * @return A lista de publicações do Feed do Autor específico
     */
    public List<Publicacao> getPublicacoes(String autor) {
        // Cria uma lista de publicações somente-leitura
        List<Publicacao> publicacoes = new ArrayList<>();
        // Adiciona as mensagens do autor na lista de publicações
    ...
    public void curtir(int idMensagem) {
        ...
        if(mensagem != null)
            ...
            throw new RuntimeException("Mensagem " + idMensagem + " não encontrada!");
    }
